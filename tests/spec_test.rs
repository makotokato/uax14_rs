...
fn run_line_break_test() {
    let failed = [
        ...
        "\u{50005}\u{0023}",
        "\u{50005}\u{0308}\u{0023}",
        "\u{50005}\u{05D0}",
        "\u{50005}\u{0308}\u{05D0}",
        "\u{50005}\u{0030}",
        "\u{50005}\u{0308}\u{0030}",
        "\u{50005}\u{0025}",
        "\u{50005}\u{0308}\u{0025}",
        "\u{50005}\u{0024}",
        "\u{50005}\u{0308}\u{0024}",
        "\u{50005}\u{0028}",
        "\u{50005}\u{0308}\u{0028}",
        "\u{50005}\u{00A7}",
        "\u{50005}\u{0308}\u{00A7}",
        "\u{50005}\u{50005}",
        "\u{50005}\u{0308}\u{50005}",
        "\u{50005}\u{0E01}",
        "\u{50005}\u{0308}\u{0E01}",
        "\u{0E01}\u{2329}",
        "\u{0E01}\u{0308}\u{2329}",
        "\u{0E01}\u{50005}",
        "\u{0E01}\u{0308}\u{50005}",
